...
public class Main {
	...
	public static void main(String[] args) {
		...
		// file directory for examples (Intellij IDE)
		final String FILEPATH = "Sliding_Puzzles/src/example/map.txt";

		// file directory for examples (eclipse IDE)
		// final String FILEPATH = "src/example/maze10_1.txt";

		// File directory for benchmark_series (Intellij IDE)
		// final String FILEPATH ="Sliding_Puzzles/src/benchmark_series/puzzle_10.txt";

		// File directory for benchmark_series (eclipse IDE)
		// final String FILEPATH ="src/benchmark_series/puzzle_40.txt";

		// File directory for test_files (Intellij IDE)
		// final String FILEPATH = "Sliding_Puzzles/src/testFiles/test_3.txt";

		// File directory for test_files (eclipse IDE)
		// final String FILEPATH = "src/testFiles/test.txt";
	...
	public static int findPath(int[][] map, int startPointX, int startPointY, int endPointX, int endPointY) {
		...
		mazeMapPositions[startPointY][startPointX] = startPosition;
			...
			while (mainQueue.size() != 0) {
				...
				for (int i = 0; i < direction.getDirection().size(); i++) {
					...
					if (nextPosition != null) {
						...
						mazeMapPositions[nextPosition.getCoordinateVertical()][nextPosition.getCoordinateHorizontal()] = new Position(currentPosition.getCoordinateHorizontal(),
						...
						if (nextPosition.getCoordinateVertical() == endPointY
							...
							while (tempPosition != startPosition) {
								...
								count++;
								tempPosition = mazeMapPositions[tempPosition.getCoordinateVertical()][tempPosition.getCoordinateHorizontal()];
							}
							return count - 1;
						}
					}
	...
	public static Position navigate(int[][] maze, Position[][] mazeMapPositions, Position currentPosition,
		...
		if (mazeMapPositions[yCoordinate + increment * yAxisDifference][xCoordinate + increment * xAxisDifference] != null) {
			return null;
		}
